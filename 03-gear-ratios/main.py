...
input_live = """...................305.124................................432..............................................576..313.....514.................
...
for y in range(height):
	for x in range(width):
		...
		if c == "*":
			gears.append( { "x":x , "y":y , "gears":[]})

		if c.isdigit():
			digit_str += c

		if x == width-1 or c.isdigit() == False:

			if len( digit_str )> 0:
				part_number = digit_str
				digit_str = ""

				if x == width-1 and c.isdigit():
					minx = x -len( part_number )
				else:
					minx = x-len(part_number) -1
				...
				if y > 0:
					patch += rows[y-1][minx:maxx] + '\n'

				patch += rows[y][minx:maxx] + '\n'
				...
				patch = patch.translate( str.maketrans( {
					".":None ,
					"0" : None ,
					"1" : None ,
					"2" : None ,
				...
				part_numbers.append( { "pn":part_number , "valid": len(patch) > 0 , "minx":minx , "maxx": maxx , "y":y , "symbols":patch } )
				print( f"valid: {( is_neg and patch == '-' ) or is_neg == False and len(patch) > 0 }" )
				print()
				is_neg = False
...
for g in gears:
	...
	for pn in part_numbers:
		if pn.get("symbols") == '*':
			if gx >= pn.get("minx") and gx < pn.get("maxx"):
				if gy >= pn.get("y") -1 and gy <= pn.get("y") +1:
					g["gears"].append( pn.get("pn") )
...
for g in gears:
	if len( g["gears"] ) == 2 :
		ratio = int( g["gears"][0])  * int( g["gears"][1])
		g["ratio"] = ratio
		gear_ratios += ratio
